    ...
    <section class="stage" style="padding-top:0">
      <div class="decision-grid" aria-label="Cloud versus self-host decision guide">
        ...
        <article class="decision-card accent">
          ...
          <p class="decision-links"><a href="${PUBLIC_METADATA.tracked.pages.startSolo}">Start Solo</a> · <a href="${PUBLIC_METADATA.tracked.pages.startTeam}">Start Team</a> · <a href="${PUBLIC_METADATA.tracked.pages.workflows}">Workflows</a> · <a href="${PUBLIC_METADATA.tracked.pages.geminiCli}">Gemini CLI</a> · <a href="${PUBLIC_METADATA.tracked.pages.deployment}">Deployment review</a> · <a href="${PUBLIC_METADATA.tracked.pages.security}">Security</a></p>
        </article>
        <article class="decision-card">
