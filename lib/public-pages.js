    ...
    <section class="stage" style="padding-top:0">
      <div class="decision-grid" aria-label="Cloud versus self-host decision guide">
        ...
        <article class="decision-card accent">
          ...
          <p class="decision-links"><a href="${PUBLIC_METADATA.cloudDocsUrl}">Cloud docs</a> · <a href="${PUBLIC_METADATA.cloudDeploymentUrl}">Deployment review</a> · <a href="${PUBLIC_METADATA.cloudSupportUrl}">Cloud support</a></p>
        </article>
        <article class="decision-card">
          ...
          <p class="decision-links"><a href="${RUNBOOK_URL}">Runbook</a> · <a href="${PUBLIC_METADATA.cloudStatusUrl}">Raw status JSON</a> · <a href="${PUBLIC_METADATA.cloudDocsUrl}">Buyer FAQ</a></p>
        </article>
      </div>
    </section>
  `.trim();
...
function demoNote() {
  return `Self-host free for ${PUBLIC_METADATA.selfHostedToolCount} tools and full transport control, or use <a href="${PUBLIC_METADATA.canonicalSiteUrl}" target="_blank" rel="noopener noreferrer">Cloud</a> for ${PUBLIC_METADATA.cloudManagedToolCount} managed tools, deployment review, and support. Solo starts at ${PUBLIC_METADATA.cloudSoloPrice}; Team at ${PUBLIC_METADATA.cloudTeamPrice} adds ${PUBLIC_METADATA.teamAiWorkflowCount} AI workflows.`;
}

function demoFooterLinks() {
  return `<a href="${PUBLIC_METADATA.canonicalRepoUrl}">GitHub</a> · <a href="${PUBLIC_METADATA.canonicalSiteUrl}" style="color:#f0c246;text-decoration:none;font-size:0.875rem">Cloud Plans</a> · <a href="${PUBLIC_METADATA.cloudDocsUrl}" style="color:#94a3b8;text-decoration:none;font-size:0.875rem">Cloud Docs</a> · <a href="${PUBLIC_METADATA.cloudDeploymentUrl}" style="color:#94a3b8;text-decoration:none;font-size:0.875rem">Deployment Review</a> · <a href="${PUBLIC_METADATA.cloudSupportUrl}" style="color:#94a3b8;text-decoration:none;font-size:0.875rem">Cloud Support</a> · <a href="${NPM_URL}" style="color:#94a3b8;text-decoration:none;font-size:0.875rem">npm</a>`;
}
